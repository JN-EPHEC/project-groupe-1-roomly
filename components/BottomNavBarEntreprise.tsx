...
export default function BottomNavBarEntreprise({ activeTab }: BottomNavBarProps) {
  ...
  const icons = [
    { key: "menu", name: "home-outline", route: "/entreprise/home_entreprise" },
    { key: "message", name: "chatbubble-outline", route: "/entreprise/messages_entreprise" },
    { key: "favoris", name: "heart-outline", route: "/entreprise/favoris" },
    { key: "settings", name: "build-outline", route: "/entreprise/services" },
    { key: "profile", name: "person-outline", route: "/entreprise/profile" },
  ];
